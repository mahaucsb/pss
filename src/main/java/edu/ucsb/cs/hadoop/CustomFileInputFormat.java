 ...
 */
@Deprecated
public abstract class CustomFileInputFormat<K, V> implements InputFormat<K, V> {
	 ...
	 *        of inputs for the map-reduce job.
	 */
	 ...
	 * 
	 * @param conf Configuration of the job.
	 * @param inputPaths the {@link Path}s of the input directories/files for
	 *        the map-reduce job.
	 */
