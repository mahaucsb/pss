...
public class Config {
	...
	public static final String CIRCULAR_PROPERTY = NAMESPACE + ".circular.enable";
	...
	public static final boolean PART_DOT_VECTOR_VALUE = true;
	public static final String EXCLUDE_MYSELF_PROPERTY = NAMESPACE + ".exclude.myself";
	public static final boolean EXCLUDE_MYSELF_VALUE = true;
	public static final String BAYADRO_SKIP_PROPERTY = NAMESPACE + ".google.skip";
	public static final boolean BAYADRO_SKIP_VALUE = true;
	...
	public static final boolean SPLITABLE_VALUE = true;
	public static final String SPLIT_MB_PROPERTY = "hadoop.split.size";
	public static final Integer SPLIT_MB_VALUE = 64;
	public static final String SPLIT_S_PROPERTY = NAMESPACE + ".split.size";
	public static final Integer SPLIT_S_VALUE = 5000;
